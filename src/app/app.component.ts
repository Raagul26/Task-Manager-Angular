...
export class AppComponent {
  ...
  getAddTaskData(data: any) {
    ...
    tableCol2.innerText = data.assigned
    ...
    tableCol3.innerText = data.assignedTo
    ...
    var deleteDivClasses = ['w-4', 'transform', 'hover:text-purple-500', 'hover:scale-110']
    ...
    deleteDiv.addEventListener('click', (e) => {
      document.getElementById(data.task + data.assigned + data.assignedTo)?.remove()
    })
    ...
    this.addTaskDisplay = false
  }

  cancelEditModal(displayStatus: any) {
    this.editTaskDisplay = displayStatus
  }

  getEditTaskData(edittedRowData: any) {
    console.log(edittedRowData)
